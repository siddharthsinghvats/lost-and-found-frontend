...
import OtherUserFoundItemCard from "./OtherUserFoundCard";
import OtherUserLostItemCard from "./OtherUserLostItemCard";
          ...
          <div className="banner">
            ...
            <div className="user-lost-post">
              ...
              {!user.lostPosts ? (
                ...
                user.lostPosts.map((item, index) => (
                  <OtherUserLostItemCard key={item + "$" + index} card={item} />
                ))
              )}
            </div>
            ...
            <div className="user-found-post">
              {!user.foundPosts ? (
                ...
                user.foundPosts.map((item) => <OtherUserFoundItemCard card={item} />)
              )}
            </div>
          </div>
